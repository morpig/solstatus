...
export function EndpointMonitorDetailHeader({
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
        <div className="mt-2 text-3xl font-bold">{endpointMonitor.name}</div>
        <a
          href={endpointMonitor.url}
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center mt-1 hover:text-muted-foreground text-sm text-muted-foreground break-all"
        >
          {endpointMonitor.url}
